...
static void ImGui_ImplSDL2_UpdateMonitors()
{
    ...
    {
        // CompilationMistake: the validity of monitor DPI information on Windows depends on the application DPI awareness settings, which generally needs to be set in the manifest or at runtime.
