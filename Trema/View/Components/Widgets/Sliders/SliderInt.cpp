...
{
    SliderInt::SliderInt(std::shared_ptr<IGuiElement> parent, std::string name, int min = 0, int max = 100) :
    ...
    SliderInt::CreateSliderInt(std::shared_ptr<IGuiElement> parent, std::string name, int min, int max)
    {
